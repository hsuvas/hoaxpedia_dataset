...
df_top_titles = pd.read_csv('hoax_unified_v4.csv') #, sep='\t',names=['hoax_title','top_titles'],header=None)
...
df.to_pickle('real_dedup.pkl',protocol=4)
df.to_csv('real_dedup.csv',index=False)
